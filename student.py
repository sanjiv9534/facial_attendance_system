...
#=======================================variables==================================================================================================
        ...
        left_frame.place(x=10,y=10,width=1030,height=780) 
        
        img_left = Image.open("college_images/images2.jpeg")
        img_left = img_left.resize((650, 130), Image.ANTIALIAS)
        self.photoimg_left = ImageTk.PhotoImage(img_left)

        f_lb1 = Label(left_frame,image=self.photoimg_left)
        f_lb1.place(x=5, y=0, width=650, height=130)
        
        #current course information
        current_course_frame=LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="current_course_information",font=("times new roman",12,"bold"))
        ...
        dep_combo["values"]=("select_Department","computer","IT","MCA","civil","mechanical")
        dep_combo.current(0)
       ...
       #course
        ...
        course_combo["values"]=("select_course","FE","SE","TE","BE")
        ...
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("times new roman",12,"bold"),state="read only")
        year_combo["values"]=("select_Year","2021-22","2022-23","2023-24","2024-25")
        ...
        course_combo = ttk.Combobox(current_course_frame, textvariable=course_var, font=("times new roman", 12, "bold"), state="readonly")
        course_combo["values"] = ("select_course", "FE", "SE", "TE", "BE")
        course_combo.current(0)
        course_combo.grid(row=0, column=3, padx=2, pady=10, sticky=W)
        ...
        year_var = StringVar()
        year_combo = ttk.Combobox(current_course_frame, textvariable=year_var, font=("times new roman", 12, "bold"), state="readonly")
        year_combo["values"] = ("select_Year", "2021-22", "2022-23", "2023-24", "2024-25")
        year_combo.current(0)
        year_combo.grid(row=1, column=1, padx=2, pady=10, sticky=W)
        ...
        semester_combo["values"]=("select_Semester","semester1","semester2","semester3","semester4")
        ...
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take photo sample",width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")  
        take_photo_btn.grid(row=1,column=0) 
         
        update_btn=Button(btn_frame,text="update photo sample",width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")  
        ...
        Right_frame.place(x=750,y=10,width=1030,height=780) 
        
        
        img_right = Image.open("college_images/PIC015-converted-20%.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()==""or self.var_std_id.get()=="":
            messagebox.showerror("Errror","All filds are required",parent=self.root)
        else:
            try:
                #conn=mysql.connector.connect(host="localhost",user="root",passwd="sanjiv@162106",database="face_recognizer")
                conn=mysql.connector.connect(host="localhost",user="newuser",passwd="newpassword",database="face_recognizer")
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("success","student details has been addedd successfully",parent=self.root)
...
#========================================================update function=============================================================================kuchh problem hai
        ...
        if self.var_dep.get()=="select Department" or self.var_std_name.get()==""or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",user="newuser",passwd="newpassword",database="face_recognizer")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Division=%s,Roll=%s,Gendar=%s,Dob=%s,Email=%s,Teacher=%s,PhotoSample=%s where student_id=%s",(
                                                                                                                                                            self.var_dep.get(),
                                                                                                                                                            self.var_course.get(),
                                                                                                                                                            self.var_year.get(),
                                                                                                                                                            self.var_semester.get(),
        ...
        if self.var_dep.get()=="select Department" or self.var_std_name.get()==""or self.var_std_id.get()=="":
            ...
            try:
                ...
                for x in my_cursor.fetchall():
                    id+=1
                my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phonee=%s,Address=%s,Teacher=%s,PhotoSample=%s where student_id=%s",(
                                                                                                                                                            self.var_dep.get(),
                                                                                                                                                            self.var_course.get(),
                                                                                                                                                            self.var_year.get(),
                                                                                                                                                            self.var_semester.get(),
                ...
                self.reset_data()
                conn.close()
#====================================================load predefined data on face frontline from open cv====================================================
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        face=cv2.cvtColor(face,cv2.Color_BGR2GREY)
